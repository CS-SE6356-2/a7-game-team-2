package model;/*
 * This is a test unit for the model.Cardpile class. A Carpile object is made, and is filled with cards.
...
public class CardpileTest {
	...
	public static void main(String[] args) {
		Cardpile pile = new Cardpile();						//Makes a model.Cardpile object
		
		//add some cards
		LinkedList<Card> cards = new LinkedList<>();	//Makes a List to hold cards that will be added to the cardpile
